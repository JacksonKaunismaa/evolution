...
uniform vec2 position;  // origin of rays
...
void main(){
    ...
    float pos_x = hbox_coord.x * rays.x * rays.z - hbox_coord.y * rays.y;
    float pos_y = hbox_coord.x * rays.y * rays.z + hbox_coord.y * rays.x;
